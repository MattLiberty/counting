...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["", "counting.dart", , L, {
  ...
  Main_init: function() {
    ...
    L.Main_clearField();
    J.set$width$x($.get$Main_canvas(), 361);
    J.set$height$x($.get$Main_canvas(), 361);
    t1 = J.get$context2D$x($.get$Main_canvas());
    t1.textBaseline = "middle";
    t1.textAlign = "center";
    t1.fillStyle = "rgba(0, 0, 0, 1)";
    t1.strokeStyle = "rgba(0, 0, 0, 1)";
    t1 = J.get$onClick$x($.get$Main_canvas());
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.Main_init_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseMove$x($.get$Main_canvas());
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.Main_init_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.getElementById("restart"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.Main_init_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 10, 0, 0), L.Main_render$closure());
  },
  Main_clearField: function() {
    var n, m;
    for (n = 0; n < 9; ++n)
      for (m = 0; m < 9; ++m)
        $.get$Main_field()[n][m] = 0;
    $.get$Main_field()[4][4] = 1;
    $.Main_currentNum = 2;
  },
  Main_moveAllowed: function(x, y) {
    var t1, hasNeighbor, coords, t2, t3, xx, yy, num;
    t1 = $.get$Main_field();
    t1.length;
    if (x >>> 0 !== x || x >= 9)
      return H.ioore(t1, x);
    ...
    if (t1[y] !== 0)
      return false;
    for (t1 = new H.ListIterator($.get$Main_coordsList(), 4, 0, null), hasNeighbor = false; t1.moveNext$0();) {
      coords = t1._current;
      t2 = J.getInterceptor$asx(coords);
      t3 = t2.$index(coords, 0);
      if (typeof t3 !== "number")
        return H.iae(t3);
      xx = x + t3;
      t2 = t2.$index(coords, 1);
      if (typeof t2 !== "number")
        return H.iae(t2);
      yy = y + t2;
      ...
      t2.length;
      if (xx >>> 0 !== xx || xx >= 9)
        return H.ioore(t2, xx);
      t2 = t2[xx];
      t2.length;
      if (yy >>> 0 !== yy || yy >= 9)
        return H.ioore(t2, yy);
      num = t2[yy];
      if (num === $.Main_currentNum)
        return false;
  ...
  Main_render: [function(timer) {
    var context, n, t1, x, t2, t3, m, num, y, t4;
    if ($.Main_nowRendering)
      return;
    context = J.get$context2D$x($.get$Main_canvas());
    context.font = "bold 32px Courier";
    context.clearRect(0, 0, J.get$width$x($.get$Main_canvas()), J.get$height$x($.get$Main_canvas()));
    context.beginPath();
    for (n = 0; n <= 9; ++n) {
      t1 = n * 40;
      context.moveTo(0, t1);
      context.lineTo(J.get$width$x($.get$Main_canvas()), t1);
      context.moveTo(t1, 0);
      context.lineTo(t1, J.get$height$x($.get$Main_canvas()));
    }
    for (n = 0; n < 9; ++n)
      for (x = n * 40, t1 = x + 20, t2 = t1 - 1, t3 = x + 4, m = 0; m < 9; ++m) {
        num = $.get$Main_field()[n][m];
        y = m * 40;
        switch (num) {
          case -1:
            context.strokeRect(t3, y + 4, 32, 32);
            break;
          case 0:
            if (L.Main_moveAllowed(n, m))
              context.strokeRect(t2, y + 20 - 1, 3, 3);
            break;
          default:
            t4 = J.toString$0(num);
            context.fillText(t4, t1, y + 20);
            break;
        }
      }
    context.clearRect($.Main_cursorX, $.Main_cursorY, 20, 20);
    context.fillStyle = "rgba(0, 0, 0, 1)";
    context.strokeRect($.Main_cursorX, $.Main_cursorY, 20, 20);
    context.font = "bold 16px Courier";
    t1 = C.JSInt_methods.toString$0($.Main_currentNum);
    t2 = $.Main_cursorX;
    if (typeof t2 !== "number")
      return t2.$add();
    t3 = $.Main_cursorY;
    if (typeof t3 !== "number")
      return t3.$add();
    C.CanvasRenderingContext2D_methods.fillText$3(context, t1, t2 + 10, t3 + 10);
    context.closePath();
    context.stroke();
    $.Main_nowRendering = false;
  }, "call$1", "Main_render$closure", 2, 0, 1],
  Main_init_closure: {
    "^": "Closure:10;",
    call$1: function(e) {
      var t1, t2, t3, t4, x1, y1, num1, coords, t5, xx, yy, num;
      t1 = J.getInterceptor$x(e);
      t2 = t1.get$offset(e);
      t2 = t2.get$x(t2);
      if (typeof t2 !== "number")
        return t2.$tdiv();
      t2 = C.JSNumber_methods._tdivFast$1(t2, 40);
      t1 = t1.get$offset(e);
      t1 = t1.get$y(t1);
      if (typeof t1 !== "number")
        return t1.$tdiv();
      t1 = C.JSNumber_methods._tdivFast$1(t1, 40);
      if (L.Main_moveAllowed(t2, t1)) {
        t3 = $.get$Main_field();
        t3.length;
        if (t2 >>> 0 !== t2 || t2 >= 9)
        ...
        t3[t1] = t4;
        for (t3 = new H.ListIterator($.get$Main_coordsList(), 4, 0, null), x1 = null, y1 = null, num1 = 0; t3.moveNext$0();) {
          coords = t3._current;
          t4 = J.getInterceptor$asx(coords);
          t5 = t4.$index(coords, 0);
          if (typeof t5 !== "number")
            return H.iae(t5);
          xx = t2 + t5;
          t4 = t4.$index(coords, 1);
          if (typeof t4 !== "number")
            return H.iae(t4);
          yy = t1 + t4;
          t4 = $.get$Main_field();
          t4.length;
          if (xx >>> 0 !== xx || xx >= 9)
            return H.ioore(t4, xx);
          t5 = t4[xx];
          t5.length;
          if (yy >>> 0 !== yy || yy >= 9)
            return H.ioore(t5, yy);
          num = t5[yy];
          if ($.Main_currentNum !== num) {
            if (typeof num !== "number")
              return num.$gt();
            t5 = num > 0;
          } else
          ...
          if (t5)
            if (num1 === 0) {
              ...
              y1 = yy;
              x1 = xx;
            } else if (num == null ? num1 != null : num !== num1) {
              t4[t2][t1] = -1;
              if (x1 >>> 0 !== x1 || x1 >= 9)
                return H.ioore(t4, x1);
              t5 = t4[x1];
              t5.length;
              if (y1 >>> 0 !== y1 || y1 >= 9)
                return H.ioore(t5, y1);
              t5[y1] = -1;
              t4[xx][yy] = -1;
            }
        }
        t1 = $.Main_currentNum;
        $.Main_currentNum = t1 === 3 ? 1 : t1 + 1;
      }
    },
    $isFunction: true
  },
  Main_init_closure0: {
    ...
    call$1: function(e) {
      ...
      t1 = J.getInterceptor$x(e);
      t2 = t1.get$offset(e);
      $.Main_cursorX = t2.get$x(t2);
      t1 = t1.get$offset(e);
      $.Main_cursorY = t1.get$y(t1);
    },
    $isFunction: true
  },
  Main_init_closure1: {
...
Isolate.$lazy($, "field", "Main_field", "get$Main_field", function() {
  return H.setRuntimeTypeInfo(Array(9), [[P.List, P.$int]]);
});
Isolate.$lazy($, "canvas", "Main_canvas", "get$Main_canvas", function() {
  return document.getElementById("canvas");
});
Isolate.$lazy($, "coordsList", "Main_coordsList", "get$Main_coordsList", function() {
...
//# sourceMappingURL=counting.dart.js.map
